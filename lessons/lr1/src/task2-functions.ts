...
type ProductFilter = {category?: string, inStock?: boolean, minPrice?: number, maxPrice?: number, tag?: string}
...
function sortProducts(products: Array<Product>, sortBy: 'name'|'price'|'createdAt', order: 'desc'|'asc') {
